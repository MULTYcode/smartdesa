...
export default async function RootLayout({
  ...
  let gaId = getRuntimeEnv("NEXT_PUBLIC_GOOGLE_ANALYTICS_ID");
  try {
  ...
  return (
    <html lang="en">
      <head>
        {/* Runtime env-config.js generated by docker-entrypoint.sh for K8s Pod injection */}
...
async function generateMetadata()  {
  try {
    ...
    const heroResponse = await SettingService.getSetting (`hero-${getRuntimeEnv("NEXT_PUBLIC_VILLAGE_ID")}`)
    return {
     ...
     return {
      title: getRuntimeEnv("NEXT_PUBLIC_VILLAGE_NAME", "Pemerintah Kabupaten Muara Enim"),
