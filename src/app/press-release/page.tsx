...
export default function PressReleaseListPage() {
  ...
  const pressReleaseData = data?.pages.flatMap((page: any) => page?.data) ?? []
  ...
  <div className="px-6 sm:px-0 max-w-lg md:max-w-3xl lg:max-w-5xl xl:max-w-6xl 2xl:max-w-7xl flex flex-col lg:flex-row gap-6 p-6">
